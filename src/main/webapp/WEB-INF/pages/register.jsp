...
<body>
	<header>
		<h3>计算机机房预约系统账号申请书</h3>
	</header>
	<article>
	<div class="col-md-4 hidden-xs"></div>
		<div class="col-md-5 col-xs-12">
			<form id="registerForm" role="form" class="form-horizontal" action="register.do" method="post" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label for="Role" class="col-xs-4 col-sm-2 control-label">用途：</label>
					<div class="col-xs-12 col-sm-4">
					<select size="1" id="Role" name="Role" class="form-control">
						<option value="2" selected>校外人员</option>
				...
				<div class="form-group">
 				...
 				<div class="form-group">
 					<label class="col-sm-6 col-xs-12 control-label">
 						<a href="aboutRules.do" style="line-height:26px">《机房使用条款》</a>
 					</label>
