		...
		<div class="personal col-sm-9 col-xs-12">
			...
			<c:forEach items="${roomNames}" var="rn">
				<div class="list-group">
					...
					<a href="/admin/toDeleteCourse.do?name=${rn.roomName}" style="background:#BCD2EE" class="list-group-item"> <span class="glyphicon glyphicon-ok-circle"></span> ${rn.roomName}</a>
					</c:if>
