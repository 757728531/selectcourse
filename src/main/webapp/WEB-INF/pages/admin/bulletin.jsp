	...
	<div class="container-fluid body">
		...
		<div class="personal col-sm-9 col-xs-12">
			...
			<div class="list-group">
				...
				<a onclick="if(confirm('确定删除该公告?')==false)return false;" href="deleteBulletin.do?id=${bl.id}"><button class="btn btn-danger btn-xs">删除</button></a>
				</c:forEach>
			</div>
			<div class="list-group">
				<a class="list-group-item-text" href="/admin/toAddBulletin.do"><button class="btn btn-info">添加公告</button></a>
			</div>
		</div>
	</div>
</body>
