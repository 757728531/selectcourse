...
<body>
	<div class="container-fluid body">
		...
		<div class="personal col-sm-9 col-xs-12">
			...
			<div class="list-group">
				<a href="toUpdatePersonal.do"><button class="btn btn-info">修改个人信息</button></a>
				<a href="toUpdateUserPwd.do"><button class="btn btn-warning">修改密码</button></a>
			</div>
		</div>
...
<c:if test="${deleteInfo=='Y'}">
	<script type="text/javascript">
        $(function() {
            function modal() {
                $('#myModalLabel').html('提示！');
                $('#infoCon').html('您已经对所有课程进行了格式化，可以通过手动方式添加新课程！');
                $('#myModal').modal();
            }
