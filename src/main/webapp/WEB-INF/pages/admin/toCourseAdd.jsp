			...
			<table class="table table-striped table-bordered table-hover">
					...
					<tr>
						...
						<c:forEach items="${courseNodeList0}" var="node1">
							...
							<c:if test="${node1.courseName==null}">
								<td>
									<a href="toHandAddCourse.do?roomName=${roomName}&week=${node1.courseWeek}&node=第1,2节">课程添加</a>
								</td>
							</c:if>
						</c:forEach>
					</tr>
					<tr>
						...
						<c:forEach items="${courseNodeList1}" var="node2">
							...
							<c:if test="${node2.courseName==null}">
								<td>
									<a href="toHandAddCourse.do?roomName='${roomName}'&week='${node2.courseWeek}'&node='第3,4节'">课程添加</a>
								</td>
							</c:if>
						</c:forEach>
					</tr>
					<tr>
						...
						<c:forEach items="${courseNodeList2}" var="node3">
							...
							<c:if test="${node3.courseName==null}">
								<td>
									<a href="toHandAddCourse.do?roomName=${roomName}&week=${node3.courseWeek}&node=第5节">课程添加</a>
								</td>
							</c:if>
						</c:forEach>
					</tr>
					<tr>
						...
						<c:forEach items="${courseNodeList3}" var="node4">
							...
							<c:if test="${node4.courseName==null}">
								<td>
									<a href="toHandAddCourse.do?roomName=${roomName}&week=${node4.courseWeek}&node=第6,7节">课程添加</a>
								</td>
							</c:if>
						</c:forEach>
					</tr>
					<tr>
						...
						<c:forEach items="${courseNodeList4}" var="node5">
							...
							<c:if test="${node5.courseName==null}">
								<td>
									<a href="toHandAddCourse.do?roomName=${roomName}&week=${node5.courseWeek}&node=第8,9节">课程添加</a>
								</td>
							</c:if>
						</c:forEach>
					</tr>
					<tr>
						...
						<c:forEach items="${courseNodeList5}" var="node6">
							...
							<c:if test="${node6.courseName==null}">
								<td>
									<a href="toHandAddCourse.do?roomName=${roomName}&week=${node6.courseWeek}&node=第10,11节">课程添加</a>
								</td>
							</c:if>
						</c:forEach>
					</tr>
					<tr>
						...
						<c:forEach items="${courseNodeList6}" var="node7">
							...
							<c:if test="${node7.courseName==null}">
								<td>
									<a href="toHandAddCourse.do?roomName=${roomName}&week=${node7.courseWeek}&node=第12节">课程添加</a>
								</td>
							</c:if>
						</c:forEach>
					</tr>
