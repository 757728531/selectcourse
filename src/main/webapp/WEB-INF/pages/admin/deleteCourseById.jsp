								...
								<dd>${node1.weekWeek}</dd>
							 	...
							 	<dd>
								 	<c:if test="${node1.courseName!=null}">
								 		<a href="deleteCourseById.do?id=${node1.id}" onclick="if(confirm('确定要删除该课程?')==false)return false;">删除课表！</a>
								 	</c:if>
							 	</dd>
						  	</dl>
					 	</td>
								...
								<dd>${node2.weekWeek}</dd>
							 	...
							 	<dd>
								 	<c:if test="${node2.courseName!=null}">
								 		<a href="deleteCourseById.do?id=${node2.id}" onclick="if(confirm('确定要删除该课程?')==false)return false;">删除课表！</a>
								 	</c:if>
							 	</dd>
						  	</dl>
					 	</td>
								...
								<dd>${node3.weekWeek}</dd>
							 	...
							 	<dd>
								 	<c:if test="${node3.courseName!=null}">
								 		<a href="deleteCourseById.do?id=${node3.id}" onclick="if(confirm('确定要删除该课程?')==false)return false;">删除课表！</a>
								 	</c:if>
							 	</dd>
						  	</dl>
					 	</td>
								...
								<dd>${node4.weekWeek}</dd>
							 	...
							 	<dd>
								 	<c:if test="${node4.courseName!=null}">
								 		<a href="deleteCourseById.do?id=${node4.id}" onclick="if(confirm('确定要删除该课程?')==false)return false;">删除课表！</a>
								 	</c:if>
							 	</dd>
						  	</dl>
					 	</td>
								...
								<dd>${node5.weekWeek}</dd>
							 	...
							 	<dd>
								 	<c:if test="${node5.courseName!=null}">
								 		<a href="deleteCourseById.do?id=${node5.id}" onclick="if(confirm('确定要删除该课程?')==false)return false;">删除课表！</a>
								 	</c:if>
							 	</dd>
						  	</dl>
					 	</td>
								...
								<dd>${node6.weekWeek}</dd>
							 	...
							 	<dd>
								 	<c:if test="${node6.courseName!=null}">
								 		<a href="deleteCourseById.do?id=${node6.id}" onclick="if(confirm('确定要删除该课程?')==false)return false;">删除课表！</a>
								 	</c:if>
							 	</dd>
						  	</dl>
					 	</td>
								...
								<dd>${node7.weekWeek}</dd>
							 	...
							 	<dd>
								 	<c:if test="${node7.courseName!=null}">
								 		<a href="deleteCourseById.do?id=${node7.id}" onclick="if(confirm('确定要删除该课程?')==false)return false;">删除课表！</a>
								 	</c:if>
							 	</dd>
						  	</dl>
					 	</td>
