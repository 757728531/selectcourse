...
<div class="container-fluid body">
		...
		<div class="update col-sm-9 col-xs-12">
			<form id="updateForm" role="form" class="form-horizontal" action="updatePersonal.do" method="post">
				...
				<div class="form-group">
					<label for="userId" class="col-xs-4 col-sm-2 control-label">登录名：</label>
					<div class="col-sm-6 col-xs-12">
				...
				<button type="button" id="back" onclick="location.href='/admin/index.do'" class="btn btn-warning" >返回主页</button>
				...
				<div class="form-group">
					<div class="alert alert-info alert-dismissable">
						...
						*暂只开放163、126、新浪邮箱的信息发送功能,消息接收方无邮箱限制！
						授权码由管理员根据自己邮箱开启相应POP3/SMTP服务获得。
					</div>
				</div>
				</form>
			</div>
