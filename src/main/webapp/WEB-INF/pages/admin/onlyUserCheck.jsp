	...
	<div class="container-fluid body">
			...
			<div class="personal col-sm-9 col-xs-12">	
				...
				<div class="list-group-item">
					<a onclick="if(confirm('确定通过用户申请?')==false)return false;" href="updateUserCheck.do"><button class="btn btn-success">通过</button></a>
					<a onclick="if(confirm('确定拒绝该用户申请?')==false)return false;" href="deleteUserCheck.do"><button class="btn btn-warning">拒绝</button></a>
				</div>
